...
void VOFA_UART1_Poll(void)
{
    ...
    if (s_uart1_mode == UART1_LINK_MODE_VOFA)
    {
        ...
        /* Combined joystick command for website / ESP32 / VOFA testing:
         *   #P15=<yaw_rate_dps>,P8=<speed_rpm>!
         * It must be checked before the generic single-parameter #P parser.
         */
        if (Balance_HandleJoystickCommand(local_cmd))
        {
            return;
        }
