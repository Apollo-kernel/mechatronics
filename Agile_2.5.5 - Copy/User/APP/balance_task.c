...
/*
 * Speed loop target: chassis forward command in encoder raw units per 20 ms sample.
 ...
 * Flip the sign if the robot drives backward instead of forward.
 */
#define SPEED_TARGET_FORWARD_RPM     15.0f
#define SPEED_TARGET_D_RAW_20MS      ((SPEED_TARGET_FORWARD_RPM) * 32768.0f / 3000.0f)
