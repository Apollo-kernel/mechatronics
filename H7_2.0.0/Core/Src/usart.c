...
void MX_USART10_UART_Init(void)
{
  ...
  huart10.AdvancedInit.AdvFeatureInit = UART_ADVFEATURE_TXINVERT_INIT|UART_ADVFEATURE_RXINVERT_INIT;
  huart10.AdvancedInit.TxPinLevelInvert = UART_ADVFEATURE_TXINV_ENABLE;
  huart10.AdvancedInit.RxPinLevelInvert = UART_ADVFEATURE_RXINV_ENABLE;
